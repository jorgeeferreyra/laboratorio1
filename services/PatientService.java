...
public class PatientService implements Service {
	...
	private PatientListPanel doctorListPanel;
	private PatientFormPanel doctorFormPanel;
	...
	public void build() {
		this.doctorListPanel = new PatientListPanel(this);
		this.doctorFormPanel = new PatientFormPanel(this);
	}
