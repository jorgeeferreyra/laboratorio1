...
public class PatientTableModel extends TableModel<Patient> {
	...
	public PatientTableModel(PatientService service) {
		super(new String[] {"ID", "Obra Social", "Nombre", "Apellido", "Teléfono", "Email"});
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
			...
			case PatientTableModel.HEALTH_ASSURANCE_ID_COLUMN:
				return service.getHealthAssuranceName(patient);
